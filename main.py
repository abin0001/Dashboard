...
MQTT_SERVER = "192.168.66.209"
MQTT_PATH = "Soilmoisture"
MQTT_PUBTOPIC = "Water_pump"

dict_data={"mois":None,"temp":None,"humi":None,"UV":None,"Air":None,"Co2":None,"Rain":None}
...
def on_message(client, userdata, msg):
    ...
    dict_data["mois"]= data[0]
    dict_data["temp"]= data[1]
    dict_data["humi"]= data[2]
    dict_data["UV"]= data[3]
    dict_data["Air"]= data[4]
    dict_data["Co2"]= data[6]
    dict_data["Rain"]= data[6]
    ...
    try:
        ...
        client1 = mqtt.Client("Motor1");
        client1.on_publish = on_publish
        client1.connect(MQTT_SERVER,1884)
